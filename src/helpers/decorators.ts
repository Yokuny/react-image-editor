...
export function preventScaleReset(target: Object, methodName: string, descriptor: PropertyDescriptor): void {
...
export function disableHistoryRecording(target: Object, methodName: string, descriptor: PropertyDescriptor): void {
  let method = descriptor.value;
  descriptor.value = async function (...args: any) {
