    ...
    <>
      <div className="toolbar__content">
        <div className="toolbar__options toolbar__options_one-col">
          <div className={`toolbar__option ${canvasStore.flipX ? "toolbar__option_active" : ""}`} onClick={() => canvasStore.setFlipX(!canvasStore.flipX)}>
            <FlipX /> <p> Flip X</p>
          </div>

          <div className={`toolbar__option ${canvasStore.flipY ? "toolbar__option_active" : ""}`} onClick={() => canvasStore.setFlipY(!canvasStore.flipY)}>
            <FlipY /> <p> Flip Y</p>
          </div>
